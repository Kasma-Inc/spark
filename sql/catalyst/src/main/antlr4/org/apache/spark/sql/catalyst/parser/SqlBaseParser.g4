...
matchExpression
    : MATCH LEFT_PAREN leftNode=multipartIdentifier MINUS LEFT_PAREN edgeTable=multipartIdentifier RIGHT_PAREN ARROW rightNode=multipartIdentifier RIGHT_PAREN ;
